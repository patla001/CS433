...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Description : read a text file and apply SJF method" << std::endl;
    std::cout << "=================================" << std::endl;
	...
	PCB X; // initialize object
    	// adds the input into the object
	...
	id++;
     ...
     std::cout << "/////////////////////////////////////////////////////" << std::endl;
     // assign the paramenter that needs to be sorted
     string nameType = "burst";
     // it sort the burst time from the linked list
     Q1.sort(nameType);
     ...
     cout <<"----------------------------------------------------"<< endl;
     cout << "Average Turnaround Time for SJF: " << avgtt << endl;
     cout << "Turnaround Time standard deviation: +/- " << stdtt << endl;
     cout <<"----------------------------------------------------"<< endl;
     cout << "Average Waiting Time for SJF: " << avgwtime << endl;
